    ...
    slides: [
      {
        title      :  '12 animals',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/12-animals.png'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'time to win',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/time-to-win.png'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'firecrackers',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/fire-crackers.png'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'chance machine',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/chance-machine.png'),
        alt        :  'Lorem ipsum',
      }
      ,
      {
        title      :  'santas shop',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/santa-shop.png'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'gold diggers',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/gold-diggers.png'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'Book of guardians',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/book-guardians.png'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'Colossus Kingdom',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/colossus-kingdom.png'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'Mermaids Treasure',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/mermaids.png'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'The ogre village',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/ogre-village.png'),
        alt        :  'Lorem ipsum',
      }
    ]
  }),
