<template>
  <div class="slot-slider">
    <Carousel class="slot-slider__slider slot-slider__list max-container" :settings="settings" :breakpoints="breakpoints" :touchDrag="false">
      <Slide class="" v-for="(slide, index) in slides" :key="index">
  ...
  data: () => ({
    ...
    slides: [
      ...
      },
      {
        title      :  'Juicy fruits',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/juicy-fruits.jpg'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'Mystic rift',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/mystic-rift.jpg'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'Pixie Magic',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/pixie-magic.jpg'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'sister of luck',
        subtitle   :  'Provider',
        image      :  require('@/assets/images/casino-games/sister-luck.jpg'),
        alt        :  'Lorem ipsum',
      },
      {
        title      :  'Dog house',
